		...
		<div class="card card-block">
			<h4 class="card-title text-primary">Cadastro de Usuário</h4>
				...
				<div class="card-text">
					<div class="col-md-10">
						<?php
							$atributos = array('class'=>'form-horizontal', 'id'=>'formsalvar');
							echo form_open_multipart('usuario/create',$atributos);
							?>
							...
							<div class="row">
								<div class="col-md-10">		
									<div class="md-form">
										<input type="text" class="form-control validate" name="nick_name">
							...
							<div class="row">
								<div class="col-md-5">	
									<div class="md-form">
										<input type="email" class="form-control validate" name="login">
										<label for="form9" data-error="inválido" data-success="ok">E-mail</label>
									</div>							
								</div>
								<div class="col-md-5">	
									<div class="md-form">
										<input type="password" class="form-control validate" name="password_key">
							...
							<div class="row">
								<div class="col-md-10">
									<div class="md-form">
										<textarea name="short_description" class="md-textarea validate"></textarea>
